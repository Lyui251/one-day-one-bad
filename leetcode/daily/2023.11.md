...
11.19
=====
[689. 三个无重叠子数组的最大和](https://leetcode.cn/problems/maximum-sum-of-3-non-overlapping-subarrays/)   <font color=red>困难</font>
...
11.21
=====
[2216. 美化数组的最少删除数](https://leetcode.cn/problems/minimum-deletions-to-make-array-beautiful/)   <font color=orange>中等(1510)</font>
...
练习 2
329. 矩阵中的最长递增路径
330. 网格图中递增路径的数目 2001

练习 3
1289. 下降路径最小和 II 1697
1290. 矩阵中和能被 K 整除的路径 1952
1291. 摘樱桃
1292. 摘樱桃 II 1957
...
11.23
=====
[2824. 统计和小于目标的下标对数目 ](https://leetcode.cn/problems/count-pairs-whose-sum-is-less-than-target/)   <font color=green>简单(1166)</font>
